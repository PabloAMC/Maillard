...
| direction / ranking skill (83-claim literature panel) | **19 of 33** strictly independent evaluable claims; **14 of 26** with pH and water activity set aside, **5 of 7** on pH and water activity; 30 independent claims not evaluable |
...
**Directional and ranking claims are the product, and the core scores 19 of 33 on them.**
[`core_directional_scores.md`](results/validation/core_directional_scores.md) runs every claim of
the 83-claim literature panel ([`directional_claims_panel.yml`](docs/validation/directional_claims_panel.yml))
