...
| direction / ranking skill (87-claim literature panel) | **20 of 37** strictly independent evaluable claims; **15 of 30** with pH and water activity set aside, **5 of 7** on pH and water activity; 30 independent claims not evaluable |
...
**Directional and ranking claims are the product, and the core scores 20 of 37 on them.**
[`core_directional_scores.md`](results/validation/core_directional_scores.md) runs every claim of
the 87-claim literature panel ([`directional_claims_panel.yml`](docs/validation/directional_claims_panel.yml))
...
- **Directional and ranking claims are the product, and on the kinetic core they score 20/37 on strictly independent literature claims** (30 independent claims not evaluable: refused arms, prose-only claims, observables the core does not represent) -- 15/30 once pH and water activity are set aside, and 5/7 on pH and water activity themselves, 0 of the misses being identical predictions across an axis the lane carries no term for. A coin scores ~0.5 on binary orderings; read the per-axis rows below, not the aggregate.
