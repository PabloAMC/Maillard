...
| direction / ranking skill (78-claim literature panel) | **19 of 32** strictly independent evaluable claims; **14 of 25** with pH and water activity set aside, **5 of 7** on pH and water activity; 27 independent claims not evaluable |
...
**Directional and ranking claims are the product, and the core scores 19 of 32 on them.**
[`core_directional_scores.md`](results/validation/core_directional_scores.md) runs every claim of
the 78-claim literature panel ([`directional_claims_panel.yml`](docs/validation/directional_claims_panel.yml))
...
| Direction / ranking on `sugar_identity` | any (sugar swap, conditions held) | 4/9 on the directional panel (independent claims)<br/><sub>misses: SUG-03, SUG-12, HOF-02, HOF-03, DIC-01</sub> | **do-not-use** |
...
| Direction / ranking on `temperature` | any (temperature moved, everything else held) | 6/10 on the directional panel (independent claims)<br/><sub>misses: TEMP-01, TEMP-05, YIL-01, YIL-02</sub> | caution |
