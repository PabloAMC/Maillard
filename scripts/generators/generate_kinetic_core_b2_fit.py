#!/usr/bin/env python3
"""
scripts/generators/generate_kinetic_core_b2_fit.py
...
120 C dimer fractions and Cerny 2007's 1x/2x pair live ONLY in the hold-out
scorer. `tests/unit/test_kinetic_core_b2_firewall.py` greps this file and the
`src/kinetic_core/` sulfur modules for those literals and fails if any appears.
...
Usage:
    python scripts/generators/generate_kinetic_core_b2_fit.py [--starts N] [--quick]
"""
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        ...
        "generated_by": "scripts/generators/generate_kinetic_core_b2_fit.py",
    ...
    lines: List[str] = []
    a = lines.append
    a("# Kinetic core, Build Wave B2 -- the sulfur fit")
    a("")
