...
def main() -> int:
    ...
    rows = build_matrix_benchmark_deltas(target_tag=args.target_tag)
    ...
    markdown_path = output_dir / "matrix_benchmark_deltas.md"
    json_path = output_dir / "matrix_benchmark_deltas.json"
