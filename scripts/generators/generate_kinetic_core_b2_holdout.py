...
CELSIUS = 273.15
OX_AMBIENT = 1.0
FIT_REPORT = ROOT / "results/validation/kinetic_core_b2_fit_report.json"
...
def main() -> int:
    ...
    out_json = ROOT / "results/validation/kinetic_core_b2_holdout_report.json"
    ...
    out_md = ROOT / "results/validation/kinetic_core_b2_holdout_report.md"
    out_md.write_text("\n".join(lines))
