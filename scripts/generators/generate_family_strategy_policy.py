...
def main() -> int:
    ...
    markdown = render_family_strategy_policy_markdown(payload)

    output_dir = ROOT / args.output_dir
    output_dir.mkdir(parents=True, exist_ok=True)

    markdown_path = output_dir / "family_strategy_policy.md"
    json_path = output_dir / "family_strategy_policy.json"
