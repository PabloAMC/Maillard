...
THE FIT STAGE OF BUILD WAVE B2.2 (kinetic core, Modules 1-2: sulfur formation
and thiol consumption).

WHAT B2.2 CHANGES, AND WHY -- BOTH CHANGES ARE B2.1's OWN DIAGNOSIS, ACTED ON
===========================================================================
...
`results/validation/kinetic_core_b2_2_fit_report.{json,md}` together with the
...
scorer. `tests/unit/test_kinetic_core_b2_2.py` greps this file and the
...
Usage:
    python scripts/generators/generate_kinetic_core_b2_2_fit.py [--starts N] [--quick]
"""
    ...
    for start in range(starts):
        ...
        if best is None or cost < best.cost:
            ...
            try:
                ...
                (ROOT / "scratch/b22_best_x.json").write_text(json.dumps({
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        ...
        "generated_by": "scripts/generators/generate_kinetic_core_b2_2_fit.py",
    ...
    lines: List[str] = []
    a = lines.append
    a("# Kinetic core, Build Wave B2.2 -- separated decay barriers + a pH-trajectory state")
    a("")
