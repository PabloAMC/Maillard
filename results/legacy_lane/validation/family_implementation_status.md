...
* **06 Alternative protein matrix scope** — Not reaction chemistry. Implemented as the matrix layer: src/matrix_correction.py (accessibility + volatile retention per protein type). The per-source registry (data/lit/protein_source_registry.json) was withdrawn 2026-09-01 as self-declared mocked.
