...
| --- | --- | ---: | --- | --- |
| protein_system | free | 16 | covered | present in current benchmark set |
| protein_system | pea_iso | 3 | covered | present in current benchmark set |
| protein_system | soy_iso | 2 | covered | present in current benchmark set |
...
| process_state | aqueous_pre_extrusion_model | 2 | covered | present in current benchmark set |
| process_state | heated_matrix | 2 | covered | present in current benchmark set |
| execution_path | free_precursor | 16 | covered | free-AA sulfur and safety envelope |
| execution_path | matrix_only | 3 | covered | matrix off-flavour intake/headspace envelope |
| execution_path | matrix_precursor_augmented | 2 | covered | matrix meaty-positive reproducibility harness envelope |
