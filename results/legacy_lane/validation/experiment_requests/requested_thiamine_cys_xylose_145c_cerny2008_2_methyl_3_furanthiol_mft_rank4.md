# Experiment Request `requested_thiamine_cys_xylose_145c_cerny2008_2_methyl_3_furanthiol_mft_rank4`

VoI rank **#4**, score **3.95**.
Generated from the current Monte-Carlo benchmark envelope.

## Why this experiment

- Compound: **2-Methyl-3-furanthiol (MFT)**
- Envelope miss: 0.50 dex
- 90% CI width: 0.18 dex
- ODT: 0.007 µg/kg; decision relevance 2.55
- Rationale: measured outside 90% CI by 0.50 dex; CI width 0.18 dex; ≈4e+02× ODT (decision_relevance=2.55); critical meaty odorant in a FREE-PRECURSOR system — the open question is absolute yield vs precursor dose and temperature, not matrix transfer



## Benchmark context

- Benchmark target: `thiamine_cys_xylose_145C_Cerny2008`
- Protein type: `free`
- Conditions: {"temp_C": 145.0, "ph": 6.0, "water_activity": 0.98, "time_min": 20.0}
...
- [ ] Confirm target compound identity and calibrate over a range spanning BOTH the published value (≈ 2.47 ppb) and the model's 90% CI midpoint (≈ 0.779859 ppb). They differ by 3.17× — that disagreement is *why* this experiment is ranked, so a calibration range covering only one of them cannot resolve it.
...
- Pre-filled intake YAML: `data/protocols/requested_thiamine_cys_xylose_145c_cerny2008_2_methyl_3_furanthiol_mft_rank4.yaml`
