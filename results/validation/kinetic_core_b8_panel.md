...
**GATING: 8 / 30 passed.** Diagnostic: 8 / 16. Unscoreable or explicitly deferred: 3.

**MEDIAN |log10 FOLD| ON THE GATING ROWS: 0.862** (geometric-mean fold 17.05x, n=29). All scored rows: 0.827 (13.32x, n=41).
...
|---|---:|---|
| `hofmann_ribose_pH3_MFT` | 0.0403x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 / MFT` |
| `hofmann_ribose_pH3_FFT` | 7.06x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 / FFT` |
| `hofmann_ribose_pH7_MFT` | 0.00695x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 / MFT` |
| `hofmann_ribose_pH7_FFT` | 0.00794x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 / FFT` |

**GATING TRAJECTORY: B2.1 15 / 33 -> B2.2 12 / 33 -> B2.3 9 / 31 on the same denominator, 8 / 30 after Amendment 9's permanent demotion of `kang_140C_MFT`.**
...
**Against B2.2: 12 / 33 gating.** B2.3 adds no row and removes none, so the denominators match and the totals ARE directly comparable. **1 FIXED, 4 REGRESSED.**

## B2.1 versus B2.2 versus B2.3, row by row

| row | gating | B2.1 fold | B2.1 | B2.2 fold | B2.2 | B2.3 fold | B2.3 | vs B2.2 |
|---|---|---:|---|---:|---|---:|---|---|
| `zhou_pH8_MFT` | yes | 0.628x | PASS | 0.343x | PASS | 0.391x | PASS | unchanged |
| `zhou_pH8_FFT` | yes | 0.00312x | **FAIL** | 0.381x | PASS | 0.309x | **FAIL** | REGRESSED |
| `zhou_pH8_MFTD` | yes | 0.701x | PASS | 4.33x | **FAIL** | 0.0684x | **FAIL** | unchanged |
| `zhou_pH8_ACTZ` | yes | 0.000719x | **FAIL** | 0.00028x | **FAIL** | 0.00304x | **FAIL** | unchanged |
| `zhou_pH8_FUR_arp_alone` | yes | 0.000744x | **FAIL** | 7.46x | **FAIL** | 0.118x | **FAIL** | unchanged |
| `zhou_MFT_shape_pH8_over_pH7` | yes | 1.28x | PASS | 0.509x | PASS | 1.4x | PASS | unchanged |
| `zhou_FFT_shape_pH8_over_pH7` | yes | 0.00524x | **FAIL** | 0.779x | PASS | 0.91x | PASS | unchanged |
| `zhou_pH6_MFT` | no | 0.0576x | **FAIL** | 1.82x | PASS | 0.665x | PASS | unchanged |
| `zhou_pH6_FFT` | no | 2.15x | PASS | 0.402x | PASS | 0.847x | PASS | unchanged |
| `zhou_pH6_MFTD` | no | 0.000259x | **FAIL** | 0.238x | **FAIL** | 0.00973x | **FAIL** | unchanged |
| `zhou_fig3_grid` | no | -- | -- | -- | -- | -- | -- | unchanged |
| `zhou_582_vs_665_consistency` | yes | 0.00032x | **FAIL** | 9.84e-07x | **FAIL** | 5.91e-06x | **FAIL** | unchanged |
...
| `cerny2003_intact_skeleton_share_95C` | yes | 1.02x | PASS | 0.0147x | **FAIL** | 0.000151x | **FAIL** | unchanged |
| `route_mix_moves_with_temperature` | no | -- | PASS | -- | **FAIL** | -- | PASS | FIXED |
| `hofmann_dry_180C` | yes | -- | -- | -- | -- | -- | -- | unchanged |
| `hofmann_ribose_pH3_MFT` | yes | 0.0589x | **FAIL** | 0.0468x | **FAIL** | 0.0403x | **FAIL** | unchanged |
| `hofmann_ribose_pH3_FFT` | yes | 24.8x | **FAIL** | 1.47x | PASS | 7.06x | **FAIL** | REGRESSED |
| `hofmann_ribose_pH7_MFT` | yes | 1.13x | PASS | 0.00539x | **FAIL** | 0.00695x | **FAIL** | unchanged |
| `hofmann_ribose_pH7_FFT` | yes | 0.379x | PASS | 0.208x | **FAIL** | 0.00794x | **FAIL** | unchanged |
| `meynier_MFT_pH_fold` | no | 0.0159x | **FAIL** | 3.87x | PASS | 10.7x | **FAIL** | REGRESSED |
| `meynier_FFT_pH_fold` | no | 5.31x | PASS | 12.2x | **FAIL** | 1.35e+03x | **FAIL** | unchanged |
| `meynier_FUR_pH_fold` | no | 0.21x | PASS | 0.416x | PASS | 0.635x | PASS | unchanged |
| `hofmann2002_brew_80C_FFT` | yes | 2.88x | PASS | 2.96x | PASS | 0.389x | PASS | unchanged |
| `vanseeventer_50C_MFT_per_day` | yes | 1.38x | PASS | 1.66x | PASS | 0.511x | PASS | unchanged |
| `zhang_115C_MFT_consumed_share` | yes | 0.473x | PASS | 0.981x | PASS | 0.137x | **FAIL** | REGRESSED |
| `zhou_120C_dimer_share_pH6` | yes | 0.00451x | **FAIL** | 0.131x | **FAIL** | 0.0147x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH7` | yes | 0.747x | PASS | 0.233x | **FAIL** | 0.0855x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH8` | yes | 1.12x | PASS | 12.6x | **FAIL** | 0.175x | **FAIL** | unchanged |
| `zhou_dimer_share_pH_invariance` | yes | 187x | **FAIL** | 72.4x | **FAIL** | 8.97x | **FAIL** | unchanged |
...
| `cerny2007_1x_xylose_share` | yes | 2.74x | **FAIL** | 3.69x | **FAIL** | 4.5x | **FAIL** | unchanged |
| `cerny2007_2x_xylose_share` | yes | 1.01x | PASS | 1.19x | PASS | 1.37x | PASS | unchanged |
| `cerny2007_branch_responsiveness` | yes | 0.369x | **FAIL** | 0.323x | **FAIL** | 0.304x | **FAIL** | unchanged |
| `kang_140C_MFT` | no (DEMOTED) | 0.000656x | **FAIL** | 2.15x | PASS | 0.382x | PASS | unchanged |
| `kang_switch_on_MFT` | no | 0.000342x | **FAIL** | 2.45x | **FAIL** | 0.444x | **FAIL** | unchanged |
| `kang_140C_FFT` | yes | 1.52e-07x | **FAIL** | 0.0706x | **FAIL** | 0.00163x | **FAIL** | unchanged |
| `kang_switch_on_FFT` | no | 3.21e-07x | **FAIL** | 0.0792x | **FAIL** | 0.00691x | **FAIL** | unchanged |
| `kang_thiols_diverge_from_their_class` | no | -- | PASS | -- | PASS | -- | PASS | unchanged |
| `kang_140C_cys_conversion` | no | 1.38x | PASS | 1.24x | PASS | 1.05x | PASS | unchanged |
| `wang2026_MFT_peak_and_fall_125_over_115` | no (DEMOTED) | -- | -- | -- | -- | 1.21x | PASS | NEW ROW |
| `wang2026_FFT_peak_and_fall_115_over_105` | no (DEMOTED) | -- | -- | -- | -- | 5.43x | **FAIL** | NEW ROW |
| `zhai_13C_exogenous_carbon_threshold` | no (DEMOTED) | -- | -- | -- | -- | -- | **FAIL** | NEW ROW |
| `ames2001_excess_Ea_class_split` | no (DEMOTED) | -- | -- | -- | -- | -- | **FAIL** | NEW ROW |
| `sun2019_pH9_over_pH3_free_FFT` | yes | 0.0735x | **FAIL** | 0.0569x | **FAIL** | 6.71x | **FAIL** | unchanged |
...
- **`cerny2007_branch_responsiveness` (FAIL)** -- A FAIL THAT CARRIES THE WAVE'S MAIN ARCHITECTURAL RESULT. This is the row a model with fixed branch fractions fails BY CONSTRUCTION, because such a model predicts exactly 1.00x. This model predicts 0.93x against a measured 3.07x. So the branch fraction DOES respond to concentration -- the architectural requirement is met and the no-fixed-fraction design is vindicated -- but it responds about half as strongly as measured. The residual is a magnitude error in the relative reaction ORDERS of the two routes, not the structural error the row was designed to catch. Reported as a fail, because it is one.

- **`zhou_pH8_FFT` (FAIL)** -- THE ROW B2.1 EXISTS TO FIX. B2 predicted 1.23e-07 against a measured 2.85e-03 -- 0.00x -- and its report named the cause: a structural pH slope of one decade per pH unit, right in shape and far too steep in level. B2.1 changed three things and NONE of them is a fitted pH parameter: the pKa are now evaluated at reaction temperature; no pH-sensitive product has a single fully-catalysed route any more; and the thiol's pH-dependent CONSUMPTION lane, which Kumazawa measures directly at 121 C and which B2 did not have at all, now carries the part of the pH response that belongs to it. B2.1 predicts 0.000882 against the same measured 2.849e-03, a fold of 0.309x. Whether that is a pass or a fail, it is the single number by which this wave should be judged.

- **`hofmann2002_brew_80C_FFT` (PASS)** -- THE FAILURE THE DECLARATION PREDICTED AND ASKED FOR, and B2.1 attacks it from two measured directions rather than by tuning. FIRST: B2 pinned every fitted decay lump to its 145 C value and evaluated it unchanged at 80 C, so k_fft_decay alone predicted several times the measured brew loss; those lumps now carry the lumped Ea, which is a WEAKER claim than temperature-independence, not a stronger one. SECOND: Stack 2018's measured van 't Hoff enthalpy is NEGATIVE, so the thiol-electrophile equilibrium constant FALLS 5x between 30 and 80 C -- heating releases bound thiol. B2 could not express that, because its K was a temperature-independent number that the source does not print. B2 lost FFT 18x too fast; B2.1 is at 0.39x.

- **`kang_140C_MFT` (PASS)** -- THE NEW EXAM, AND THE ONE WHOSE DIRECTION OF FAILURE MATTERS MOST. Amendment 5 pre-registers that a single-Ea branch UNDER-predicts here by 3.8x, because the measured behaviour is non-Arrhenius: free-thiol formation switches on between 120 and 140 C. This module is not single-Ea at that node -- its thiol-forming flux is [carbon skeleton] x [sulfide] and the sulfide is gated behind Zheng & Ho's MEASURED 133 kJ/mol, the largest barrier in the module by a factor of two, against a lumped formation barrier for everything else. So it can also OVERSHOOT, and an overshoot is a failure of the same seriousness as an undershoot: it would mean the switch-on mechanism is real but mis-sized. MEASURED 5.907 ug/L; PREDICTED 1.977e-05 mmol/L, fold 0.382x.

## Row by row -- no averaging, no dropping

| row | group | gating | observed | predicted | fold | pass |
|---|---|---|---:|---:|---:|---|
| `zhou_pH8_MFT` | Zhou pH-8 column | yes | 0.004604 | 0.001801 | 0.39x | PASS |
| `zhou_pH8_FFT` | Zhou pH-8 column | yes | 0.002849 | 0.0008817 | 0.31x | **FAIL** |
| `zhou_pH8_MFTD` | Zhou pH-8 column | yes | 0.0002212 | 1.513e-05 | 0.07x | **FAIL** |
| `zhou_pH8_ACTZ` | Zhou pH-8 column | yes | 0.00458 | 1.394e-05 | 0.00x | **FAIL** |
| `zhou_pH8_FUR_arp_alone` | Zhou pH-8 column | yes | 0.004544 | 0.000535 | 0.12x | **FAIL** |
| `zhou_MFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.3309 | 0.4648 | 1.40x | PASS |
| `zhou_FFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.4291 | 0.3903 | 0.91x | PASS |
| `zhou_pH6_MFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.006105 | 0.004059 | 0.66x | PASS |
| `zhou_pH6_FFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.007127 | 0.006038 | 0.85x | PASS |
| `zhou_pH6_MFTD` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.0002638 | 2.567e-06 | 0.01x | **FAIL** |
| `zhou_fig3_grid` | Zhou Fig. 3 grid | no | -- | -- | -- | _not scored_ |
| `zhou_582_vs_665_consistency` | Zhou cross-system pair | yes | 0.8757 | 5.177e-06 | 0.00x | **FAIL** |
| `whitfield_2001_pH65_collapse` | Whitfield 2001 pH collapse | yes | 150 | 1.001 | 0.01x | **FAIL** |
| `cerny2003_NF_share_ceiling_95C` | Cerny 2003, 95 C | yes | 0.07 | 0.9999 | 14.28x | **FAIL** |
| `cerny2003_intact_skeleton_share_95C` | Cerny 2003, 95 C | yes | 0.93 | 0.00014 | 0.00x | **FAIL** |
| `route_mix_moves_with_temperature` | Cerny 2003, 95 C | no | -- | -- | -- | PASS |
| `hofmann_dry_180C` | Hofmann dry-180 | yes | -- | -- | -- | _not scored_ |
| `hofmann_ribose_pH3_MFT` | Hofmann pH axis | yes | 0.004844 | 0.0001955 | 0.04x | **FAIL** |
| `hofmann_ribose_pH3_FFT` | Hofmann pH axis | yes | 0.002006 | 0.01416 | 7.06x | **FAIL** |
| `hofmann_ribose_pH7_MFT` | Hofmann pH axis | yes | 0.000219 | 1.522e-06 | 0.01x | **FAIL** |
| `hofmann_ribose_pH7_FFT` | Hofmann pH axis | yes | 0.0001051 | 8.343e-07 | 0.01x | **FAIL** |
| `meynier_MFT_pH_fold` | Meynier directional | no | 152 | 1632 | 10.74x | **FAIL** |
| `meynier_FFT_pH_fold` | Meynier directional | no | 6.1 | 8209 | 1345.74x | **FAIL** |
| `meynier_FUR_pH_fold` | Meynier directional | no | 25 | 15.86 | 0.63x | PASS |
| `hofmann2002_brew_80C_FFT` | thiol sinks | yes | 0.023 | 0.008939 | 0.39x | PASS |
| `vanseeventer_50C_MFT_per_day` | thiol sinks | yes | 0.59 | 0.3012 | 0.51x | PASS |
| `zhang_115C_MFT_consumed_share` | thiol sinks | yes | 0.11 | 0.01512 | 0.14x | **FAIL** |
| `zhou_120C_dimer_share_pH6` | thiol sinks | yes | 0.086 | 0.001265 | 0.01x | **FAIL** |
| `zhou_120C_dimer_share_pH7` | thiol sinks | yes | 0.065 | 0.005555 | 0.09x | **FAIL** |
| `zhou_120C_dimer_share_pH8` | thiol sinks | yes | 0.096 | 0.01679 | 0.17x | **FAIL** |
| `zhou_dimer_share_pH_invariance` | thiol sinks | yes | 1.48 | 13.28 | 8.97x | **FAIL** |
...
| `cerny2007_1x_xylose_share` | Cerny concentration pair | yes | 0.15 | 0.6747 | 4.50x | **FAIL** |
| `cerny2007_2x_xylose_share` | Cerny concentration pair | yes | 0.46 | 0.6294 | 1.37x | PASS |
| `cerny2007_branch_responsiveness` | Cerny concentration pair | yes | 3.067 | 0.9328 | 0.30x | **FAIL** |
| `kang_140C_MFT` | Kang 140 C (NEW gating hold-out) | no | 5.174e-05 | 1.977e-05 | 0.38x | PASS |
| `kang_switch_on_MFT` | Kang 140 C (NEW gating hold-out) | no | 4.256 | 1.891 | 0.44x | **FAIL** |
| `kang_140C_FFT` | Kang 140 C (NEW gating hold-out) | yes | 0.0001002 | 1.631e-07 | 0.00x | **FAIL** |
| `kang_switch_on_FFT` | Kang 140 C (NEW gating hold-out) | no | 2.785 | 0.01924 | 0.01x | **FAIL** |
| `kang_thiols_diverge_from_their_class` | Kang 140 C (NEW gating hold-out) | no | -- | -- | -- | PASS |
| `kang_140C_cys_conversion` | Kang 140 C (NEW gating hold-out) | no | 0.626 | 0.6557 | 1.05x | PASS |
| `wang2026_MFT_peak_and_fall_125_over_115` | Wang 2026 five-rung ladder (B8 replacement) | no | 0.3 | 0.362 | 1.21x | PASS |
| `wang2026_FFT_peak_and_fall_115_over_105` | Wang 2026 five-rung ladder (B8 replacement) | no | 0.15 | 0.8147 | 5.43x | **FAIL** |
...
| `sun2019_pH9_over_pH3_free_FFT` | Sun 2019 pH-9 column | yes | 0.1481 | 0.9948 | 6.71x | **FAIL** |
