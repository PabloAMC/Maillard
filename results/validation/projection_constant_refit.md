...
| objective (all literature rows) | 0.8811 dex | 0.8620 dex |
...
Objective at fit: **0.8620 dex** over all 16 literature rows; **0.8367 dex** over the 5 rows the projection layer actually moves (the rest run on the matrix-only and safety lanes, which never touch the volatile budget).

## Versus v1 (severity sigmoid + double Boltzmann)

| Objective | v1 | v2 (this fit) |
| --- | --- | --- |
| All literature rows | 0.1469 | 0.8620 |
