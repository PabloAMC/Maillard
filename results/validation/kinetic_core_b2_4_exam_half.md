...
- **Core: 4/27 within 3.0x**, median fold error **50.13x**, worst 3.339e+04x.
...
- **GEOMETRIC-MEAN FOLD, on the same points:** core over all scored **62.59x**; on the paired subset core **62.59x** vs old **16.8x**. A median moves only when a row crosses the middle of the pool; a geometric mean moves whenever any row moves, including a row that was already failing.
...
|---|---:|---:|---:|---:|
| **buffer-completed** | 27 | 4 | 50.13x | **50.13x** |
| **as-was (no buffer field)** | 27 | 2 | 46.67x | **46.67x** |
...
| `sulfur_hofmann1998_145C` | 10 | 12.44x | 3 | 16.95x | 1 |
...
|---|---|---|---|---:|---:|---|
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 61.36x | 13.85x | closer |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 31.39x | 397.2x | **further** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 8.881x | 2.499x | closer |
...
| `sulfur_hofmann1998_145C` | 10 | 10 | 0 | 3 | 0 | 12.44x | 13.77x |
...
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 7 | 951.2 | 135.9x | ANSWERED | 96.93 | 13.85x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 3 | 1519 | 506.4x | ANSWERED | 33.09 | 11.03x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 6 | 343.4 | 57.23x | ANSWERED | 0.01511 | 397.2x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 4 | 22.85 | 5.713x | ANSWERED | 9.997 | 2.499x | PASS |
...
| 2 to 7 of the 23 in-envelope points inside band, most likely 4 | **HELD** | 4/27 inside the 3.0x band |
