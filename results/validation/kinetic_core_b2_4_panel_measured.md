...
**MEDIAN |log10 FOLD| ON THE GATING ROWS: 0.581** (geometric-mean fold 12.81x, n=31). All scored rows: 0.575 (11.19x, n=39).
...
|---|---:|---|
| `hofmann_ribose_pH3_MFT` | 0.0241x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 / MFT` |
| `hofmann_ribose_pH3_FFT` | 6.9x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 / FFT` |
| `hofmann_ribose_pH7_MFT` | 0.00185x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 / MFT` |
| `hofmann_ribose_pH7_FFT` | 0.00164x | `mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 / FFT` |
...
|---|---|---:|---|---:|---|---:|---|---|
| `zhou_pH8_MFT` | yes | 0.628x | PASS | 0.343x | PASS | 0.659x | PASS | unchanged |
| `zhou_pH8_FFT` | yes | 0.00312x | **FAIL** | 0.381x | PASS | 0.412x | PASS | unchanged |
| `zhou_pH8_MFTD` | yes | 0.701x | PASS | 4.33x | **FAIL** | 0.525x | PASS | FIXED |
| `zhou_pH8_ACTZ` | yes | 0.000719x | **FAIL** | 0.00028x | **FAIL** | 0.00198x | **FAIL** | unchanged |
| `zhou_pH8_FUR_arp_alone` | yes | 0.000744x | **FAIL** | 7.46x | **FAIL** | 0.189x | **FAIL** | unchanged |
| `zhou_MFT_shape_pH8_over_pH7` | yes | 1.28x | PASS | 0.509x | PASS | 1.1x | PASS | unchanged |
| `zhou_FFT_shape_pH8_over_pH7` | yes | 0.00524x | **FAIL** | 0.779x | PASS | 0.722x | PASS | unchanged |
| `zhou_pH6_MFT` | no | 0.0576x | **FAIL** | 1.82x | PASS | 1.83x | PASS | unchanged |
| `zhou_pH6_FFT` | no | 2.15x | PASS | 0.402x | PASS | 1.72x | PASS | unchanged |
| `zhou_pH6_MFTD` | no | 0.000259x | **FAIL** | 0.238x | **FAIL** | 0.113x | **FAIL** | unchanged |
| `zhou_fig3_grid` | no | -- | -- | -- | -- | -- | -- | unchanged |
| `zhou_582_vs_665_consistency` | yes | 0.00032x | **FAIL** | 9.84e-07x | **FAIL** | 3.87e-06x | **FAIL** | unchanged |
...
| `cerny2003_intact_skeleton_share_95C` | yes | 1.02x | PASS | 0.0147x | **FAIL** | 0.00027x | **FAIL** | unchanged |
| `route_mix_moves_with_temperature` | no | -- | PASS | -- | **FAIL** | -- | PASS | FIXED |
| `hofmann_dry_180C` | yes | -- | -- | -- | -- | -- | -- | unchanged |
| `hofmann_ribose_pH3_MFT` | yes | 0.0589x | **FAIL** | 0.0468x | **FAIL** | 0.0241x | **FAIL** | unchanged |
| `hofmann_ribose_pH3_FFT` | yes | 24.8x | **FAIL** | 1.47x | PASS | 6.9x | **FAIL** | REGRESSED |
| `hofmann_ribose_pH7_MFT` | yes | 1.13x | PASS | 0.00539x | **FAIL** | 0.00185x | **FAIL** | unchanged |
| `hofmann_ribose_pH7_FFT` | yes | 0.379x | PASS | 0.208x | **FAIL** | 0.00164x | **FAIL** | unchanged |
| `meynier_MFT_pH_fold` | no | 0.0159x | **FAIL** | 3.87x | PASS | 11.7x | **FAIL** | REGRESSED |
| `meynier_FFT_pH_fold` | no | 5.31x | PASS | 12.2x | **FAIL** | 3.71e+03x | **FAIL** | unchanged |
| `meynier_FUR_pH_fold` | no | 0.21x | PASS | 0.416x | PASS | 0.696x | PASS | unchanged |
| `hofmann2002_brew_80C_FFT` | yes | 2.88x | PASS | 2.96x | PASS | 2.77x | PASS | unchanged |
| `vanseeventer_50C_MFT_per_day` | yes | 1.38x | PASS | 1.66x | PASS | 1.68x | PASS | unchanged |
| `zhang_115C_MFT_consumed_share` | yes | 0.473x | PASS | 0.981x | PASS | 1.92x | PASS | unchanged |
| `zhou_120C_dimer_share_pH6` | yes | 0.00451x | **FAIL** | 0.131x | **FAIL** | 0.0617x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH7` | yes | 0.747x | PASS | 0.233x | **FAIL** | 0.402x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH8` | yes | 1.12x | PASS | 12.6x | **FAIL** | 0.797x | PASS | FIXED |
| `zhou_dimer_share_pH_invariance` | yes | 187x | **FAIL** | 72.4x | **FAIL** | 9.74x | **FAIL** | unchanged |
...
| `cerny2007_1x_xylose_share` | yes | 2.74x | **FAIL** | 3.69x | **FAIL** | 3.81x | **FAIL** | unchanged |
...
| `kang_140C_MFT` | no (DEMOTED) | 0.000656x | **FAIL** | 2.15x | PASS | 0.521x | PASS | unchanged |
| `kang_switch_on_MFT` | yes | 0.000342x | **FAIL** | 2.45x | **FAIL** | 0.266x | **FAIL** | unchanged |
| `kang_140C_FFT` | yes | 1.52e-07x | **FAIL** | 0.0706x | **FAIL** | 0.0225x | **FAIL** | unchanged |
| `kang_switch_on_FFT` | yes | 3.21e-07x | **FAIL** | 0.0792x | **FAIL** | 0.0386x | **FAIL** | unchanged |
...
| `sun2019_pH9_over_pH3_free_FFT` | yes | 0.0735x | **FAIL** | 0.0569x | **FAIL** | 0.0738x | **FAIL** | unchanged |
...
- **`kang_140C_MFT` (PASS)** -- THE NEW EXAM, AND THE ONE WHOSE DIRECTION OF FAILURE MATTERS MOST. Amendment 5 pre-registers that a single-Ea branch UNDER-predicts here by 3.8x, because the measured behaviour is non-Arrhenius: free-thiol formation switches on between 120 and 140 C. This module is not single-Ea at that node -- its thiol-forming flux is [carbon skeleton] x [sulfide] and the sulfide is gated behind Zheng & Ho's MEASURED 133 kJ/mol, the largest barrier in the module by a factor of two, against a lumped formation barrier for everything else. So it can also OVERSHOOT, and an overshoot is a failure of the same seriousness as an undershoot: it would mean the switch-on mechanism is real but mis-sized. MEASURED 5.907 ug/L; PREDICTED 2.698e-05 mmol/L, fold 0.521x.

## Row by row -- no averaging, no dropping

| row | group | gating | observed | predicted | fold | pass |
|---|---|---|---:|---:|---:|---|
| `zhou_pH8_MFT` | Zhou pH-8 column | yes | 0.004604 | 0.003036 | 0.66x | PASS |
| `zhou_pH8_FFT` | Zhou pH-8 column | yes | 0.002849 | 0.001174 | 0.41x | PASS |
| `zhou_pH8_MFTD` | Zhou pH-8 column | yes | 0.0002212 | 0.0001161 | 0.52x | PASS |
| `zhou_pH8_ACTZ` | Zhou pH-8 column | yes | 0.00458 | 9.09e-06 | 0.00x | **FAIL** |
| `zhou_pH8_FUR_arp_alone` | Zhou pH-8 column | yes | 0.004544 | 0.0008607 | 0.19x | **FAIL** |
| `zhou_MFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.3309 | 0.3654 | 1.10x | PASS |
| `zhou_FFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.4291 | 0.3098 | 0.72x | PASS |
| `zhou_pH6_MFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.006105 | 0.0112 | 1.83x | PASS |
| `zhou_pH6_FFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.007127 | 0.01228 | 1.72x | PASS |
| `zhou_pH6_MFTD` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.0002638 | 2.971e-05 | 0.11x | **FAIL** |
| `zhou_fig3_grid` | Zhou Fig. 3 grid | no | -- | -- | -- | _not scored_ |
| `zhou_582_vs_665_consistency` | Zhou cross-system pair | yes | 0.8757 | 3.392e-06 | 0.00x | **FAIL** |
...
| `cerny2003_intact_skeleton_share_95C` | Cerny 2003, 95 C | yes | 0.93 | 0.0002515 | 0.00x | **FAIL** |
| `route_mix_moves_with_temperature` | Cerny 2003, 95 C | no | -- | -- | -- | PASS |
| `hofmann_dry_180C` | Hofmann dry-180 | yes | -- | -- | -- | _not scored_ |
| `hofmann_ribose_pH3_MFT` | Hofmann pH axis | yes | 0.004844 | 0.0001166 | 0.02x | **FAIL** |
| `hofmann_ribose_pH3_FFT` | Hofmann pH axis | yes | 0.002006 | 0.01384 | 6.90x | **FAIL** |
| `hofmann_ribose_pH7_MFT` | Hofmann pH axis | yes | 0.000219 | 4.056e-07 | 0.00x | **FAIL** |
| `hofmann_ribose_pH7_FFT` | Hofmann pH axis | yes | 0.0001051 | 1.723e-07 | 0.00x | **FAIL** |
| `meynier_MFT_pH_fold` | Meynier directional | no | 152 | 1771 | 11.65x | **FAIL** |
| `meynier_FFT_pH_fold` | Meynier directional | no | 6.1 | 2.265e+04 | 3712.70x | **FAIL** |
| `meynier_FUR_pH_fold` | Meynier directional | no | 25 | 17.4 | 0.70x | PASS |
| `hofmann2002_brew_80C_FFT` | thiol sinks | yes | 0.023 | 0.06367 | 2.77x | PASS |
| `vanseeventer_50C_MFT_per_day` | thiol sinks | yes | 0.59 | 0.989 | 1.68x | PASS |
| `zhang_115C_MFT_consumed_share` | thiol sinks | yes | 0.11 | 0.2114 | 1.92x | PASS |
| `zhou_120C_dimer_share_pH6` | thiol sinks | yes | 0.086 | 0.005308 | 0.06x | **FAIL** |
| `zhou_120C_dimer_share_pH7` | thiol sinks | yes | 0.065 | 0.02611 | 0.40x | **FAIL** |
| `zhou_120C_dimer_share_pH8` | thiol sinks | yes | 0.096 | 0.07649 | 0.80x | PASS |
| `zhou_dimer_share_pH_invariance` | thiol sinks | yes | 1.48 | 14.41 | 9.74x | **FAIL** |
...
| `cerny2007_1x_xylose_share` | Cerny concentration pair | yes | 0.15 | 0.5712 | 3.81x | **FAIL** |
| `cerny2007_2x_xylose_share` | Cerny concentration pair | yes | 0.46 | 0.526 | 1.14x | PASS |
| `cerny2007_branch_responsiveness` | Cerny concentration pair | yes | 3.067 | 0.9209 | 0.30x | **FAIL** |
| `kang_140C_MFT` | Kang 140 C (NEW gating hold-out) | no | 5.174e-05 | 2.698e-05 | 0.52x | PASS |
| `kang_switch_on_MFT` | Kang 140 C (NEW gating hold-out) | yes | 4.256 | 1.132 | 0.27x | **FAIL** |
| `kang_140C_FFT` | Kang 140 C (NEW gating hold-out) | yes | 0.0001002 | 2.258e-06 | 0.02x | **FAIL** |
| `kang_switch_on_FFT` | Kang 140 C (NEW gating hold-out) | yes | 2.785 | 0.1076 | 0.04x | **FAIL** |
| `kang_thiols_diverge_from_their_class` | Kang 140 C (NEW gating hold-out) | no | -- | -- | -- | PASS |
| `kang_140C_cys_conversion` | Kang 140 C (NEW gating hold-out) | no | 0.626 | 0.6808 | 1.09x | PASS |
| `sun2019_pH9_over_pH3_free_FFT` | Sun 2019 pH-9 column | yes | 0.1481 | 0.01093 | 0.07x | **FAIL** |
