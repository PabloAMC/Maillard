...
| T3 medians | floor 0.121 dex from 42 seed pairs; 0 unreached medians beyond it | True |
| T4 | 5 widened; newly inside 0 | reported |

## The measured Monte-Carlo noise floor

Two runs of the SAME priors at different seeds, 42 rows compared. Relative difference in interval width: median 3.09%, 95th percentile 13.37%, worst 16.99%.
