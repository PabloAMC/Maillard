...
- **GEOMETRIC-MEAN FOLD, on the same points:** core over all scored **63.06x**; on the paired subset core **63.06x** vs old **16.8x**. A median moves only when a row crosses the middle of the pool; a geometric mean moves whenever any row moves, including a row that was already failing.
...
| **as-was (no buffer field)** | 27 | 2 | 46.03x | **46.03x** |
...
| `sulfur_hofmann1998_145C` | 10 | 12.43x | 3 | 16.88x | 1 |
| `sulfur_yiltirak2026_T_ladder` | 8 | 213.4x | 0 | 511.5x | 0 |

### Every point the buffer field moved

| bundle | compound | buffer | provenance | as-was fold | completed fold | |
|---|---|---|---|---:|---:|---|
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 61.13x | 13.83x | closer |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 31.32x | 390.4x | **further** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 8.876x | 2.493x | closer |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 6.654x | 6.917x | **further** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 204.2x | 41.53x | closer |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 32.16x | 610.1x | **further** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 21.17x | 540x | **further** |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 12.58x | 2.917x | closer |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 2.984x | 2.417x | closer |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 46.03x | 37.77x | closer |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 2698x | 696.8x | closer |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 125.3x | 105.7x | closer |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 2787x | 761.1x | closer |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 175.4x | 150.8x | closer |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 1899x | 557.1x | closer |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 182.1x | 159.3x | closer |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 840.9x | 267.5x | closer |
...
| `sulfur_hofmann1998_145C` | 10 | 10 | 0 | 3 | 0 | 12.43x | 13.77x |
| `sulfur_yiltirak2026_T_ladder` | 8 | 8 | 0 | 0 | 1 | 213.4x | 16.77x |
...
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 7 | 951.2 | 135.9x | ANSWERED | 96.78 | 13.83x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 3 | 1519 | 506.4x | ANSWERED | 33.08 | 11.03x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 6 | 343.4 | 57.23x | ANSWERED | 0.01537 | 390.4x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 4 | 22.85 | 5.713x | ANSWERED | 9.97 | 2.493x | PASS |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) *(re-score)* | ppb | 229 | 1409 | 6.151x | ANSWERED | 1584 | 6.917x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) *(re-score)* | ppb | 553 | 2878 | 5.204x | ANSWERED | 13.31 | 41.53x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) *(re-score)* | ppb | 12 | 624.7 | 52.06x | ANSWERED | 0.01967 | 610.1x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) *(re-score)* | ppb | 25 | 316.2 | 12.65x | ANSWERED | 0.0463 | 540x | **FAIL** |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | ppb | 96 | 1429 | 14.88x | ANSWERED | 280 | 2.917x | PASS |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) | ppb | 143 | 713.7 | 4.991x | ANSWERED | 345.6 | 2.417x | PASS |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 6.88 | 8.556 | 1.244x | ANSWERED | 259.8 | 37.77x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.28 | 15.44 | 12.06x | ANSWERED | 891.9 | 696.8x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 3.29 | 15.71 | 4.775x | ANSWERED | 347.7 | 105.7x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.46 | 33.17 | 22.72x | ANSWERED | 1111 | 761.1x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 2.4 | 26.07 | 10.86x | ANSWERED | 361.9 | 150.8x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.68 | 61.28 | 36.48x | ANSWERED | 936 | 557.1x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Methyl-3-furanthiol (MFT) | ppb | 1.71 | 36.73 | 21.48x | ANSWERED | 272.4 | 159.3x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Furfurylthiol (FFT) | ppb | 1.62 | 83.99 | 51.85x | ANSWERED | 433.3 | 267.5x | **FAIL** |
...
| Yiltirak: UNDER-prediction, worsening as temperature falls | **HALF-FALSIFIED** | DIRECTION WRONG -- the core OVER-predicts at 4/4 rungs, not under. GRADIENT RIGHT -- the worst rung is not the 100 C one (696.8x). |
