...
* mixed-population coverage: 7/39 (0.179)
* **honest literature coverage: 7/33 (0.212)**, median CI width 1.450 log10; 6 not evaluable; 0 fitted rows excluded
* out-of-sample literature coverage: 7/32 (6 not evaluable); rows the core fit read: {'hits': 0, 'total': 1, 'not_evaluable': 0}
* sampled priors 44, fixed 40; lanes with NO sampled fit uncertainty: none
...
|---|---|---|---|---|---|
| external_matrix | 2 | 4 | 0.500 | 2.203 | 0 |
| maillard_path_holdout | 4 | 21 | 0.190 | 0.994 | 5 |
| trust_loop | 1 | 8 | 0.125 | 1.966 | 1 |
...
| hofmann1998_norfuraneol_cysteine_145C_20min_pH5 | trust_loop | 2-Methyl-3-furanthiol (MFT) | ppb | 1.02e+03 | 2.35e+03 | 1.54e+03 | 2.27e+03 | 2.78e+03 | no | 0.256 | no (extraction) | sulfur | predictive [in core fit] |
| hofmann1998_ribose_cysteine_145C_20min_pH5 | trust_loop | 2-Furfurylthiol (FFT) | ppb | 121.000 | 830.643 | 51.756 | 1.24e+03 | 9.99e+03 | yes | 2.286 | no (extraction) | sulfur | predictive |
| hofmann1998_ribose_cysteine_145C_20min_pH5 | trust_loop | 2-Methyl-3-furanthiol (MFT) | ppb | 198.000 | 730.638 | 363.451 | 662.597 | 1.09e+03 | no | 0.478 | no (extraction) | sulfur | predictive |
| pea_isolate_40C_PratapSingh2021 | trust_loop | hexanal | ppb | 1.14e+03 | 0.339 | 0.030 | 0.268 | 4.719 | no | 2.203 | yes (headspace) | lipid | predictive |
| pea_isolate_uht_140C_Trikusuma2019 | trust_loop | hexanal | ppb | 782.000 | 22.839 | 1.219 | 17.475 | 496.280 | no | 2.610 | yes (headspace) | lipid | predictive |
| resconi_2023_pbma_beef_identity_benchmark | trust_loop | furfural | ppb | 715.220 | 7.665 | 1.380 | 8.743 | 73.936 | no | 1.729 | yes (headspace) | sulfur | predictive |
| soy_isolate_40C_PratapSingh2021 | trust_loop | hexanal | ppb | 1.62e+03 | 0.267 | 0.023 | 0.211 | 3.714 | no | 2.203 | yes (headspace) | lipid | predictive |
| thiamine_cys_glucose_120C_Bolton1994 | trust_loop | 2-Methyl-3-furanthiol (MFT) | ppb | 11.700 | 235.973 | 48.882 | 108.318 | 210.184 | no | 0.633 | no (extraction) | sulfur | predictive |
| mp_holdout_fructose_asparagine_180C_Lin2022 | maillard_path_holdout | Acrylamide | ppb | 1.86e+03 | 225.440 | 74.895 | 210.259 | 667.510 | no | 0.950 | no (extraction) | acrylamide | external_holdout |
...
| mp_holdout_glucose_alanine_130C_2h_pH50_Schibilsky2019 | maillard_path_holdout | DMHF | ppb | 1.15e+03 | 21.841 | 7.136 | 20.631 | 70.438 | no | 0.994 | no (extraction) | acrylamide | external_holdout |
...
| mp_holdout_glucose_alanine_130C_2h_pH80_Schibilsky2019 | maillard_path_holdout | DMHF | ppb | 5.89e+03 | 21.841 | 7.136 | 20.631 | 70.438 | no | 0.994 | no (extraction) | acrylamide | external_holdout |
...
| mp_holdout_glucose_asparagine_180C_10min_Chang2021 | maillard_path_holdout | Acrylamide | ppb | 28.000 | 6.75e+03 | 2.13e+03 | 5.96e+03 | 1.68e+04 | no | 0.896 | no (extraction) | acrylamide | external_holdout |
| mp_holdout_glucose_asparagine_180C_30min_Chang2021 | maillard_path_holdout | Acrylamide | ppb | 1.46e+03 | 4.03e+03 | 1.34e+03 | 3.76e+03 | 1.19e+04 | yes | 0.950 | no (extraction) | acrylamide | external_holdout |
| mp_holdout_glucose_asparagine_180C_30min_water_Chang2021 | maillard_path_holdout | Acrylamide | ppb | 832.000 | 4.03e+03 | 1.34e+03 | 3.76e+03 | 1.19e+04 | no | 0.950 | no (extraction) | acrylamide | external_holdout |
...
| mp_holdout_glucose_asparagine_180C_Ye2024 | maillard_path_holdout | Acrylamide | umol_per_mol_limiting_precursor | 140.580 | 7.04e+03 | 2.34e+03 | 6.56e+03 | 2.09e+04 | no | 0.951 | no (extraction) | acrylamide | external_holdout |
| mp_holdout_glucose_only_autoclave_121C_Steinhagen2021 | maillard_path_holdout | 5-Hydroxymethylfurfural (HMF) | ppb | 1.74e+04 | 1.46e+03 | 1.46e+03 | 1.46e+03 | 1.46e+03 | no | 7.02e-07 | no (extraction) | trunk | external_holdout |
| mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 229.000 | 1.13e+03 | 63.924 | 1.65e+03 | 1.25e+04 | yes | 2.292 | no (extraction) | sulfur | external_holdout (shared: hofmann_ribose_pH3_FFT) |
| mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH3 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 553.000 | 23.470 | 11.296 | 21.224 | 37.445 | no | 0.520 | no (extraction) | sulfur | external_holdout (shared: hofmann_ribose_pH3_MFT) |
| mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 12.000 | 0.090 | 0.00404 | 0.091 | 0.654 | no | 2.209 | no (extraction) | sulfur | external_holdout (shared: hofmann_ribose_pH7_FFT) |
| mp_holdout_hofmann1998_ribose_cysteine_145C_20min_pH7 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 25.000 | 0.178 | 0.040 | 0.158 | 0.265 | no | 0.822 | no (extraction) | sulfur | external_holdout (shared: hofmann_ribose_pH7_MFT) |
| mp_holdout_hofmann1998_xylose_cysteine_145C_20min_pH5 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 96.000 | 191.058 | 24.535 | 288.469 | 2e+03 | yes | 1.911 | no (extraction) | sulfur | external_holdout |
| mp_holdout_hofmann1998_xylose_cysteine_145C_20min_pH5 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 143.000 | 546.398 | 291.328 | 502.988 | 730.621 | no | 0.399 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_100C_4h_Yiltirak2026 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 6.880 | 64.086 | 1.493 | 9.426 | 42.715 | yes | 1.457 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_100C_4h_Yiltirak2026 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 1.280 | 610.255 | 29.641 | 202.789 | 1.1e+03 | no | 1.571 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_110C_2h_Yiltirak2026 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 3.290 | 96.892 | 5.434 | 22.661 | 76.055 | no | 1.146 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_110C_2h_Yiltirak2026 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 1.460 | 535.496 | 36.968 | 289.482 | 1.39e+03 | no | 1.574 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_120C_1h_Yiltirak2026 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 2.400 | 134.513 | 18.542 | 52.997 | 129.225 | no | 0.843 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_120C_1h_Yiltirak2026 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 1.680 | 363.445 | 40.779 | 316.506 | 1.44e+03 | no | 1.547 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_130C_30min_Yiltirak2026 | maillard_path_holdout | 2-Methyl-3-furanthiol (MFT) | ppb | 1.710 | 170.534 | 48.035 | 101.650 | 198.657 | no | 0.617 | no (extraction) | sulfur | external_holdout |
| mp_holdout_ribose_cysteine_buffer_130C_30min_Yiltirak2026 | maillard_path_holdout | 2-Furfurylthiol (FFT) | ppb | 1.620 | 211.740 | 41.883 | 255.100 | 1.18e+03 | no | 1.450 | no (extraction) | sulfur | external_holdout |
| external_validation_bi_2020_raw_pea_hexanal | external_matrix | hexanal | ppb | 1.26e+03 | 0.339 | 0.030 | 0.268 | 4.719 | no | 2.203 | yes (headspace) | lipid | external_holdout |
| external_validation_bi_2020_roasted_pea_hexanal | external_matrix | hexanal | ppb | 324.000 | 88.598 | 7.808 | 71.060 | 1.14e+03 | yes | 2.166 | yes (headspace) | lipid | external_holdout |
| external_validation_li_2026_spi_wg_hme_control | external_matrix | hexanal | ppb | 605.600 | 69.695 | 5.169 | 51.837 | 838.746 | yes | 2.210 | yes (headspace) | lipid | external_holdout |
| external_validation_liu_2023_ppi_offnote_baseline | external_matrix | hexanal | ppb | 1.13e+04 | 0.339 | 0.030 | 0.268 | 4.719 | no | 2.203 | yes (headspace) | lipid | external_holdout |
...
| acrylamide.aw_multiplier | acrylamide | declared_band | uniform | 1.000 | - | [0.410, 1.390] | yes | declared band: the source's four a_w point estimates and the 0.92 column's 95 % HPD, relative to the shipped constant |
