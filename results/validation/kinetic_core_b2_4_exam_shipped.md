...
- **GEOMETRIC-MEAN FOLD, on the same points:** core over all scored **62.23x**; on the paired subset core **62.23x** vs old **16.8x**. A median moves only when a row crosses the middle of the pool; a geometric mean moves whenever any row moves, including a row that was already failing.
...
| **as-was (no buffer field)** | 27 | 2 | 47.53x | **47.53x** |
...
| `sulfur_hofmann1998_145C` | 10 | 12.4x | 3 | 16.88x | 1 |
| `sulfur_yiltirak2026_T_ladder` | 8 | 202.2x | 0 | 470.8x | 0 |

### Every point the buffer field moved

| bundle | compound | buffer | provenance | as-was fold | completed fold | |
|---|---|---|---|---:|---:|---|
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 60.9x | 13.78x | closer |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 31.21x | 391.4x | **further** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 8.876x | 2.489x | closer |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 6.641x | 6.902x | **further** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 204.8x | 41.66x | closer |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 33.7x | 572.2x | **further** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT | phosphate 0.5 M | primary_source_pdf | 21.21x | 545x | **further** |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | phosphate 0.5 M | primary_source_pdf | 12.56x | 2.904x | closer |
...
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 47.53x | 38.72x | closer |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 2461x | 628.8x | closer |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 130.5x | 109.6x | closer |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 2519x | 682.7x | closer |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 184.1x | 158.1x | closer |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 1700x | 496.5x | closer |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Methyl-3-furanthiol (MFT | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 189.4x | 165.7x | closer |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Furfurylthiol (FFT) | potassium_phosphate 0.5 M | repo_verbatim_methods_quote | 752.2x | 238.6x | closer |
...
| `sulfur_hofmann1998_145C` | 10 | 10 | 0 | 3 | 0 | 12.4x | 13.77x |
| `sulfur_yiltirak2026_T_ladder` | 8 | 8 | 0 | 0 | 1 | 202.2x | 16.77x |
...
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 7 | 951.2 | 135.9x | ANSWERED | 96.49 | 13.78x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 3 | 1519 | 506.4x | ANSWERED | 33.07 | 11.02x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Furfurylthiol (FFT) | ppb | 6 | 343.4 | 57.23x | ANSWERED | 0.01533 | 391.4x | **FAIL** |
| `mp_holdout_hofmann1998_glucose_cysteine_145C_2` | 2-Methyl-3-furanthiol (MFT) | ppb | 4 | 22.85 | 5.713x | ANSWERED | 9.958 | 2.489x | PASS |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) *(re-score)* | ppb | 229 | 1409 | 6.151x | ANSWERED | 1581 | 6.902x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) *(re-score)* | ppb | 553 | 2878 | 5.204x | ANSWERED | 13.27 | 41.66x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Furfurylthiol (FFT) *(re-score)* | ppb | 12 | 624.7 | 52.06x | ANSWERED | 0.02097 | 572.2x | **FAIL** |
| `mp_holdout_hofmann1998_ribose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) *(re-score)* | ppb | 25 | 316.2 | 12.65x | ANSWERED | 0.04587 | 545x | **FAIL** |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Furfurylthiol (FFT) | ppb | 96 | 1429 | 14.88x | ANSWERED | 278.8 | 2.904x | PASS |
| `mp_holdout_hofmann1998_xylose_cysteine_145C_20` | 2-Methyl-3-furanthiol (MFT) | ppb | 143 | 713.7 | 4.991x | ANSWERED | 344.2 | 2.407x | PASS |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 6.88 | 8.556 | 1.244x | ANSWERED | 266.4 | 38.72x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_100C_4h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.28 | 15.44 | 12.06x | ANSWERED | 804.8 | 628.8x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 3.29 | 15.71 | 4.775x | ANSWERED | 360.5 | 109.6x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_110C_2h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.46 | 33.17 | 22.72x | ANSWERED | 996.7 | 682.7x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Methyl-3-furanthiol (MFT) | ppb | 2.4 | 26.07 | 10.86x | ANSWERED | 379.3 | 158.1x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_120C_1h_Yilt` | 2-Furfurylthiol (FFT) | ppb | 1.68 | 61.28 | 36.48x | ANSWERED | 834.2 | 496.5x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Methyl-3-furanthiol (MFT) | ppb | 1.71 | 36.73 | 21.48x | ANSWERED | 283.4 | 165.7x | **FAIL** |
| `mp_holdout_ribose_cysteine_buffer_130C_30min_Y` | 2-Furfurylthiol (FFT) | ppb | 1.62 | 83.99 | 51.85x | ANSWERED | 386.5 | 238.6x | **FAIL** |
...
| Yiltirak: UNDER-prediction, worsening as temperature falls | **HALF-FALSIFIED** | DIRECTION WRONG -- the core OVER-predicts at 4/4 rungs, not under. GRADIENT RIGHT -- the worst rung is not the 100 C one (628.8x). |
