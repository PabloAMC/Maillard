# Experiment Request `requested_cys_ribose_140c_hofmann1998_2_methyl_3_furanthiol_rank2`

VoI rank **#2**, score **10.22**.
Generated from the current Monte-Carlo benchmark envelope.

## Why this experiment

- Compound: **2-methyl-3-furanthiol**
- Envelope miss: 0.38 dex
- 90% CI width: 2.66 dex
- ODT: 0.007 µg/kg; decision relevance 4.69
- Rationale: measured outside 90% CI by 0.38 dex; CI width 2.66 dex; ≈5e+04× ODT (decision_relevance=4.69); critical meaty odorant — multi-factor SIDA closes precursor × matrix gap
...
- [ ] Confirm target compound identity and expected dynamic range (model 90% CI midpoint ≈ 40.7568 ppb).
...
- Pre-filled intake YAML: `data/protocols/requested_cys_ribose_140c_hofmann1998_2_methyl_3_furanthiol_rank2.yaml`
