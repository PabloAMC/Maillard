# Experiment Request `requested_spi_hvp_xylose_120c_pmc9905368_2_furfurylthiol_fft_rank5`

VoI rank **#5**, score **5.05**.
Generated from the current Monte-Carlo benchmark envelope.

## Why this experiment

- Compound: **2-Furfurylthiol (FFT)**
- Envelope miss: 1.14 dex
- 90% CI width: 3.22 dex
- ODT: 0.01 µg/kg; decision relevance 1.62
- Rationale: measured outside 90% CI by 1.14 dex; CI width 3.22 dex; ≈4e+01× ODT (decision_relevance=1.62); critical meaty odorant — multi-factor SIDA closes precursor × matrix gap
...
- [ ] Confirm target compound identity and expected dynamic range (model 90% CI midpoint ≈ 0.00191214 ppb).
...
- Pre-filled intake YAML: `data/protocols/requested_spi_hvp_xylose_120c_pmc9905368_2_furfurylthiol_fft_rank5.yaml`
