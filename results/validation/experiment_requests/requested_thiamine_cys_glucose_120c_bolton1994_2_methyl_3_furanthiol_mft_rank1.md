...
VoI rank **#1**, score **12.83**.
Generated from the current Monte-Carlo benchmark envelope.

## Why this experiment

- Compound: **2-Methyl-3-furanthiol (MFT)**
- Envelope miss: 2.84 dex
- 90% CI width: 0.29 dex
- ODT: 0.007 µg/kg; decision relevance 3.27
- Rationale: measured outside 90% CI by 2.84 dex; CI width 0.29 dex; ≈2e+03× ODT (decision_relevance=3.27); critical meaty odorant — multi-factor SIDA closes precursor × matrix gap
...
- [ ] Confirm target compound identity and expected dynamic range (model 90% CI midpoint ≈ 0.0171588 ppb).
