...
**GATING: 11 / 32 passed.** Diagnostic: 6 / 10. Unscoreable or explicitly deferred: 3.
...
**Against B2.2: 12 / 33 gating.** B2.3 adds no row and removes none, so the denominators match and the totals ARE directly comparable. **3 FIXED, 4 REGRESSED.**

## B2.1 versus B2.2 versus B2.3, row by row

| row | gating | B2.1 fold | B2.1 | B2.2 fold | B2.2 | B2.3 fold | B2.3 | vs B2.2 |
|---|---|---:|---|---:|---|---:|---|---|
| `zhou_pH8_MFT` | yes | 0.628x | PASS | 0.343x | PASS | 0.651x | PASS | unchanged |
| `zhou_pH8_FFT` | yes | 0.00312x | **FAIL** | 0.381x | PASS | 0.336x | PASS | unchanged |
| `zhou_pH8_MFTD` | yes | 0.701x | PASS | 4.33x | **FAIL** | 0.471x | PASS | FIXED |
| `zhou_pH8_ACTZ` | yes | 0.000719x | **FAIL** | 0.00028x | **FAIL** | 0.00205x | **FAIL** | unchanged |
| `zhou_pH8_FUR_arp_alone` | yes | 0.000744x | **FAIL** | 7.46x | **FAIL** | 0.187x | **FAIL** | unchanged |
| `zhou_MFT_shape_pH8_over_pH7` | yes | 1.28x | PASS | 0.509x | PASS | 0.852x | PASS | unchanged |
| `zhou_FFT_shape_pH8_over_pH7` | yes | 0.00524x | **FAIL** | 0.779x | PASS | 0.463x | **FAIL** | REGRESSED |
| `zhou_pH6_MFT` | no | 0.0576x | **FAIL** | 1.82x | PASS | 1.75x | PASS | unchanged |
| `zhou_pH6_FFT` | no | 2.15x | PASS | 0.402x | PASS | 1.52x | PASS | unchanged |
| `zhou_pH6_MFTD` | no | 0.000259x | **FAIL** | 0.238x | **FAIL** | 0.0861x | **FAIL** | unchanged |
| `zhou_fig3_grid` | no | -- | -- | -- | -- | -- | -- | unchanged |
| `zhou_582_vs_665_consistency` | yes | 0.00032x | **FAIL** | 9.84e-07x | **FAIL** | 4e-06x | **FAIL** | unchanged |
...
| `cerny2003_intact_skeleton_share_95C` | yes | 1.02x | PASS | 0.0147x | **FAIL** | 0.000278x | **FAIL** | unchanged |
| `route_mix_moves_with_temperature` | no | -- | PASS | -- | **FAIL** | -- | PASS | FIXED |
| `hofmann_dry_180C` | yes | -- | -- | -- | -- | -- | -- | unchanged |
| `hofmann_ribose_pH3_MFT` | yes | 0.0589x | **FAIL** | 0.0468x | **FAIL** | 0.0237x | **FAIL** | unchanged |
| `hofmann_ribose_pH3_FFT` | yes | 24.8x | **FAIL** | 1.47x | PASS | 7.23x | **FAIL** | REGRESSED |
| `hofmann_ribose_pH7_MFT` | yes | 1.13x | PASS | 0.00539x | **FAIL** | 0.00193x | **FAIL** | unchanged |
| `hofmann_ribose_pH7_FFT` | yes | 0.379x | PASS | 0.208x | **FAIL** | 0.002x | **FAIL** | unchanged |
| `meynier_MFT_pH_fold` | no | 0.0159x | **FAIL** | 3.87x | PASS | 11.1x | **FAIL** | REGRESSED |
| `meynier_FFT_pH_fold` | no | 5.31x | PASS | 12.2x | **FAIL** | 3.25e+03x | **FAIL** | unchanged |
| `meynier_FUR_pH_fold` | no | 0.21x | PASS | 0.416x | PASS | 0.729x | PASS | unchanged |
...
| `zhang_115C_MFT_consumed_share` | yes | 0.473x | PASS | 0.981x | PASS | 1.97x | PASS | unchanged |
| `zhou_120C_dimer_share_pH6` | yes | 0.00451x | **FAIL** | 0.131x | **FAIL** | 0.0495x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH7` | yes | 0.747x | PASS | 0.233x | **FAIL** | 0.199x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH8` | yes | 1.12x | PASS | 12.6x | **FAIL** | 0.725x | PASS | FIXED |
...
| `cerny2007_1x_xylose_share` | yes | 2.74x | **FAIL** | 3.69x | **FAIL** | 3.78x | **FAIL** | unchanged |
| `cerny2007_2x_xylose_share` | yes | 1.01x | PASS | 1.19x | PASS | 1.13x | PASS | unchanged |
| `cerny2007_branch_responsiveness` | yes | 0.369x | **FAIL** | 0.323x | **FAIL** | 0.3x | **FAIL** | unchanged |
| `kang_140C_MFT` | no (DEMOTED) | 0.000656x | **FAIL** | 2.15x | PASS | 0.467x | PASS | unchanged |
| `kang_switch_on_MFT` | yes | 0.000342x | **FAIL** | 2.45x | **FAIL** | 0.226x | **FAIL** | unchanged |
| `kang_140C_FFT` | yes | 1.52e-07x | **FAIL** | 0.0706x | **FAIL** | 0.0487x | **FAIL** | unchanged |
| `kang_switch_on_FFT` | yes | 3.21e-07x | **FAIL** | 0.0792x | **FAIL** | 0.0854x | **FAIL** | unchanged |
| `kang_thiols_diverge_from_their_class` | no | -- | PASS | -- | PASS | -- | **FAIL** | REGRESSED |
| `kang_140C_cys_conversion` | no | 1.38x | PASS | 1.24x | PASS | 1.07x | PASS | unchanged |
| `sun2019_pH9_over_pH3_free_FFT` | yes | 0.0735x | **FAIL** | 0.0569x | **FAIL** | 0.0712x | **FAIL** | unchanged |
...
- **`kang_140C_MFT` (PASS)** -- THE NEW EXAM, AND THE ONE WHOSE DIRECTION OF FAILURE MATTERS MOST. Amendment 5 pre-registers that a single-Ea branch UNDER-predicts here by 3.8x, because the measured behaviour is non-Arrhenius: free-thiol formation switches on between 120 and 140 C. This module is not single-Ea at that node -- its thiol-forming flux is [carbon skeleton] x [sulfide] and the sulfide is gated behind Zheng & Ho's MEASURED 133 kJ/mol, the largest barrier in the module by a factor of two, against a lumped formation barrier for everything else. So it can also OVERSHOOT, and an overshoot is a failure of the same seriousness as an undershoot: it would mean the switch-on mechanism is real but mis-sized. MEASURED 5.907 ug/L; PREDICTED 2.417e-05 mmol/L, fold 0.467x.

## Row by row -- no averaging, no dropping

| row | group | gating | observed | predicted | fold | pass |
|---|---|---|---:|---:|---:|---|
| `zhou_pH8_MFT` | Zhou pH-8 column | yes | 0.004604 | 0.002998 | 0.65x | PASS |
| `zhou_pH8_FFT` | Zhou pH-8 column | yes | 0.002849 | 0.0009558 | 0.34x | PASS |
| `zhou_pH8_MFTD` | Zhou pH-8 column | yes | 0.0002212 | 0.0001043 | 0.47x | PASS |
| `zhou_pH8_ACTZ` | Zhou pH-8 column | yes | 0.00458 | 9.398e-06 | 0.00x | **FAIL** |
| `zhou_pH8_FUR_arp_alone` | Zhou pH-8 column | yes | 0.004544 | 0.0008492 | 0.19x | **FAIL** |
| `zhou_MFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.3309 | 0.282 | 0.85x | PASS |
| `zhou_FFT_shape_pH8_over_pH7` | Zhou pH-8 column | yes | 0.4291 | 0.1986 | 0.46x | **FAIL** |
| `zhou_pH6_MFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.006105 | 0.01066 | 1.75x | PASS |
| `zhou_pH6_FFT` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.007127 | 0.01085 | 1.52x | PASS |
| `zhou_pH6_MFTD` | Zhou pH-6 column (DIAGNOSTIC) | no | 0.0002638 | 2.272e-05 | 0.09x | **FAIL** |
| `zhou_fig3_grid` | Zhou Fig. 3 grid | no | -- | -- | -- | _not scored_ |
| `zhou_582_vs_665_consistency` | Zhou cross-system pair | yes | 0.8757 | 3.5e-06 | 0.00x | **FAIL** |
...
| `cerny2003_intact_skeleton_share_95C` | Cerny 2003, 95 C | yes | 0.93 | 0.0002582 | 0.00x | **FAIL** |
| `route_mix_moves_with_temperature` | Cerny 2003, 95 C | no | -- | -- | -- | PASS |
| `hofmann_dry_180C` | Hofmann dry-180 | yes | -- | -- | -- | _not scored_ |
| `hofmann_ribose_pH3_MFT` | Hofmann pH axis | yes | 0.004844 | 0.0001147 | 0.02x | **FAIL** |
| `hofmann_ribose_pH3_FFT` | Hofmann pH axis | yes | 0.002006 | 0.01451 | 7.23x | **FAIL** |
| `hofmann_ribose_pH7_MFT` | Hofmann pH axis | yes | 0.000219 | 4.233e-07 | 0.00x | **FAIL** |
| `hofmann_ribose_pH7_FFT` | Hofmann pH axis | yes | 0.0001051 | 2.107e-07 | 0.00x | **FAIL** |
| `meynier_MFT_pH_fold` | Meynier directional | no | 152 | 1692 | 11.13x | **FAIL** |
| `meynier_FFT_pH_fold` | Meynier directional | no | 6.1 | 1.98e+04 | 3245.62x | **FAIL** |
| `meynier_FUR_pH_fold` | Meynier directional | no | 25 | 18.22 | 0.73x | PASS |
| `hofmann2002_brew_80C_FFT` | thiol sinks | yes | 0.023 | 0.06428 | 2.79x | PASS |
| `vanseeventer_50C_MFT_per_day` | thiol sinks | yes | 0.59 | 0.989 | 1.68x | PASS |
| `zhang_115C_MFT_consumed_share` | thiol sinks | yes | 0.11 | 0.2167 | 1.97x | PASS |
| `zhou_120C_dimer_share_pH6` | thiol sinks | yes | 0.086 | 0.004261 | 0.05x | **FAIL** |
| `zhou_120C_dimer_share_pH7` | thiol sinks | yes | 0.065 | 0.01294 | 0.20x | **FAIL** |
| `zhou_120C_dimer_share_pH8` | thiol sinks | yes | 0.096 | 0.06957 | 0.72x | PASS |
| `zhou_dimer_share_pH_invariance` | thiol sinks | yes | 1.48 | 16.33 | 11.03x | **FAIL** |
...
| `cerny2007_1x_xylose_share` | Cerny concentration pair | yes | 0.15 | 0.5666 | 3.78x | **FAIL** |
| `cerny2007_2x_xylose_share` | Cerny concentration pair | yes | 0.46 | 0.5215 | 1.13x | PASS |
| `cerny2007_branch_responsiveness` | Cerny concentration pair | yes | 3.067 | 0.9203 | 0.30x | **FAIL** |
| `kang_140C_MFT` | Kang 140 C (NEW gating hold-out) | no | 5.174e-05 | 2.417e-05 | 0.47x | PASS |
| `kang_switch_on_MFT` | Kang 140 C (NEW gating hold-out) | yes | 4.256 | 0.9609 | 0.23x | **FAIL** |
| `kang_140C_FFT` | Kang 140 C (NEW gating hold-out) | yes | 0.0001002 | 4.875e-06 | 0.05x | **FAIL** |
| `kang_switch_on_FFT` | Kang 140 C (NEW gating hold-out) | yes | 2.785 | 0.238 | 0.09x | **FAIL** |
| `kang_thiols_diverge_from_their_class` | Kang 140 C (NEW gating hold-out) | no | -- | -- | -- | **FAIL** |
| `kang_140C_cys_conversion` | Kang 140 C (NEW gating hold-out) | no | 0.626 | 0.6692 | 1.07x | PASS |
| `sun2019_pH9_over_pH3_free_FFT` | Sun 2019 pH-9 column | yes | 0.1481 | 0.01054 | 0.07x | **FAIL** |
