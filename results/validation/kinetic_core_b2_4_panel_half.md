...
**GATING: 12 / 32 passed.** Diagnostic: 7 / 10. Unscoreable or explicitly deferred: 3.

**MEDIAN |log10 FOLD| ON THE GATING ROWS: 0.619** (geometric-mean fold 13.34x, n=31). All scored rows: 0.617 (11.62x, n=39).
...
**GATING TRAJECTORY: B2.1 15 / 33 -> B2.2 12 / 33 -> B2.3 13 / 33 on the same denominator, 12 / 32 after Amendment 9's permanent demotion of `kang_140C_MFT`.**

The first three numbers are directly comparable: same rows, same bands, same scorer. The fourth is the honest total AFTER Amendment 9's permanent demotion of kang_140C_MFT, and it is the one that should be quoted going forward. A wave may not improve its score by demoting rows, so the like-for-like is printed first and the demotion is itemised.
...
**Against B2.2: 12 / 33 gating.** B2.3 adds no row and removes none, so the denominators match and the totals ARE directly comparable. **3 FIXED, 2 REGRESSED.**

## B2.1 versus B2.2 versus B2.3, row by row

| row | gating | B2.1 fold | B2.1 | B2.2 fold | B2.2 | B2.3 fold | B2.3 | vs B2.2 |
|---|---|---:|---|---:|---|---:|---|---|
| `zhou_pH8_MFT` | yes | 0.628x | PASS | 0.343x | PASS | 0.639x | PASS | unchanged |
| `zhou_pH8_FFT` | yes | 0.00312x | **FAIL** | 0.381x | PASS | 0.367x | PASS | unchanged |
| `zhou_pH8_MFTD` | yes | 0.701x | PASS | 4.33x | **FAIL** | 0.491x | PASS | FIXED |
| `zhou_pH8_ACTZ` | yes | 0.000719x | **FAIL** | 0.00028x | **FAIL** | 0.00197x | **FAIL** | unchanged |
| `zhou_pH8_FUR_arp_alone` | yes | 0.000744x | **FAIL** | 7.46x | **FAIL** | 0.194x | **FAIL** | unchanged |
| `zhou_MFT_shape_pH8_over_pH7` | yes | 1.28x | PASS | 0.509x | PASS | 0.863x | PASS | unchanged |
| `zhou_FFT_shape_pH8_over_pH7` | yes | 0.00524x | **FAIL** | 0.779x | PASS | 0.519x | PASS | unchanged |
| `zhou_pH6_MFT` | no | 0.0576x | **FAIL** | 1.82x | PASS | 1.78x | PASS | unchanged |
| `zhou_pH6_FFT` | no | 2.15x | PASS | 0.402x | PASS | 1.71x | PASS | unchanged |
| `zhou_pH6_MFTD` | no | 0.000259x | **FAIL** | 0.238x | **FAIL** | 0.0905x | **FAIL** | unchanged |
...
| `hofmann2002_brew_80C_FFT` | yes | 2.88x | PASS | 2.96x | PASS | 2.78x | PASS | unchanged |
| `vanseeventer_50C_MFT_per_day` | yes | 1.38x | PASS | 1.66x | PASS | 1.68x | PASS | unchanged |
| `zhang_115C_MFT_consumed_share` | yes | 0.473x | PASS | 0.981x | PASS | 1.96x | PASS | unchanged |
| `zhou_120C_dimer_share_pH6` | yes | 0.00451x | **FAIL** | 0.131x | **FAIL** | 0.0511x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH7` | yes | 0.747x | PASS | 0.233x | **FAIL** | 0.241x | **FAIL** | unchanged |
| `zhou_120C_dimer_share_pH8` | yes | 1.12x | PASS | 12.6x | **FAIL** | 0.769x | PASS | FIXED |
| `zhou_dimer_share_pH_invariance` | yes | 187x | **FAIL** | 72.4x | **FAIL** | 11.3x | **FAIL** | unchanged |
...
| `kang_140C_MFT` | no (DEMOTED) | 0.000656x | **FAIL** | 2.15x | PASS | 0.493x | PASS | unchanged |
| `kang_switch_on_MFT` | yes | 0.000342x | **FAIL** | 2.45x | **FAIL** | 0.242x | **FAIL** | unchanged |
| `kang_140C_FFT` | yes | 1.52e-07x | **FAIL** | 0.0706x | **FAIL** | 0.0263x | **FAIL** | unchanged |
| `kang_switch_on_FFT` | yes | 3.21e-07x | **FAIL** | 0.0792x | **FAIL** | 0.046x | **FAIL** | unchanged |
...
| `sun2019_pH9_over_pH3_free_FFT` | yes | 0.0735x | **FAIL** | 0.0569x | **FAIL** | 0.0726x | **FAIL** | unchanged |
...
| `hofmann2002_brew_80C_FFT` | thiol sinks | yes | 0.023 | 0.06394 | 2.78x | PASS |
| `vanseeventer_50C_MFT_per_day` | thiol sinks | yes | 0.59 | 0.989 | 1.68x | PASS |
| `zhang_115C_MFT_consumed_share` | thiol sinks | yes | 0.11 | 0.2152 | 1.96x | PASS |
| `zhou_120C_dimer_share_pH6` | thiol sinks | yes | 0.086 | 0.004398 | 0.05x | **FAIL** |
| `zhou_120C_dimer_share_pH7` | thiol sinks | yes | 0.065 | 0.01565 | 0.24x | **FAIL** |
| `zhou_120C_dimer_share_pH8` | thiol sinks | yes | 0.096 | 0.07381 | 0.77x | PASS |
| `zhou_dimer_share_pH_invariance` | thiol sinks | yes | 1.48 | 16.78 | 11.34x | **FAIL** |
...
| `kang_140C_MFT` | Kang 140 C (NEW gating hold-out) | no | 5.174e-05 | 2.553e-05 | 0.49x | PASS |
| `kang_switch_on_MFT` | Kang 140 C (NEW gating hold-out) | yes | 4.256 | 1.029 | 0.24x | **FAIL** |
| `kang_140C_FFT` | Kang 140 C (NEW gating hold-out) | yes | 0.0001002 | 2.639e-06 | 0.03x | **FAIL** |
| `kang_switch_on_FFT` | Kang 140 C (NEW gating hold-out) | yes | 2.785 | 0.128 | 0.05x | **FAIL** |
...
| `sun2019_pH9_over_pH3_free_FFT` | Sun 2019 pH-9 column | yes | 0.1481 | 0.01076 | 0.07x | **FAIL** |
