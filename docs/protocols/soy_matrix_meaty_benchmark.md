...
**3.2 SPI has higher accessible cysteine than PPI.** Commercial soy isolate carries 0.94 g methionine + cysteine per 100 g dry matter against 0.61 for pea (Jaeger et al. 2023, one isolate each); Gorissen et al. 2018 report 0.3 + 0.2 g per 100 g raw material for both, lower bounds because their hydrolysis had no performic-acid oxidation step. Soy's disulfide inventory measured by Ellman's assay after reduction is 0.100–0.114 mmol half-cystine per g protein (Ruan 2014, Shimada 1988) against pea's 0.061–0.074 (Gao 2020). Glycinin has multiple disulfide bonds, but partial denaturation at 95–120°C exposes buried thiol groups. The soy_isolate accessible cysteine correction (0.30 in `matrix_correction.py`) is higher than PPI (0.25), reflecting greater cysteine availability under heat treatment.
