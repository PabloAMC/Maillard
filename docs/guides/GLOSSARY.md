...
| **B17** | the sink structure, variant (b): the thiol disulfide made reversible on one shared release constant. Refused; the data drove the release to zero and showed the disulfide channel is oxidant-limited. Variant (a), the saturating sink on a browning-made pool, is next | `kinetic_core_b17_prereg.md`, `kinetic_core_b17_ship_rule.md` |
