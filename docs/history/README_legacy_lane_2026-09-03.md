> **ARCHIVED 2026-09-03 (retirement step B5c).** This is the README as it stood the day the legacy SMIRKS
> screening lane was deleted. Every number and command in it describes the retired lane; the live README is
> at the repository root and the retired lane's artifacts are under `results/legacy_lane/`. Kept verbatim as
> the record; the generated model-card block below is frozen and no longer regenerated.
...
<!-- frozen model-card block (2026-09-03) -->
