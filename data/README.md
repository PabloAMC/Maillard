...
Tracked files: **336**. Local-only (gitignored): `data/articles/` (primary-source PDFs, ~160 MB).
...
197 files covered by the directory description above: `Cai2024_extraction.md`, `Meynier2002_extraction.md`, `Xin2026b_extraction.md`, `Zhang2024_extraction.md`, `Zhou2025_extraction.md`, `adams2008_extraction.md`, `agcam2022_extraction.md`, `ajandouz2008_extraction.md`, `ames2001_extraction.md`, `amranihemaimi1995_extraction.md`, `anantharamkrishnan2020_extraction.md`, `anantharamkrishnan2020b_extraction.md` …
