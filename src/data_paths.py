...
# --------------------------------------------------------------------------- data/keys
# The join layer (Phase 3). Generated by scripts/generators/build_compound_registry.py.
KEYS_DIR: Path = DATA_ROOT / "keys"
COMPOUND_REGISTRY: Path = KEYS_DIR / "compounds.yml"
